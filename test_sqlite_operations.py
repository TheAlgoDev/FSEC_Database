...
class TestSQLiteDB(unittest.TestCase):
    ...
    def create_test_table(cls):
        ...
        logger.info("Test table successfully inserted %s", cls.test_table_name)
    ...
    def drop_test_table(cls):
        ...
        logger.info("Test table dropped %s", cls.test_table_name)
    ...
    def test_create_sqlite_record(self):
        ...
        logger.info(f"Test record inserted %s", self.test_table_name)
